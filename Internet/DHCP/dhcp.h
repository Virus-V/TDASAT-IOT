...
// DHCP client initialization (outside of the main loop) <- tmp
void DHCP_init(uint8_t s, uint8_t * buf);

// DHCP client in the main loop <- tmp
uint8_t DHCP_run(void);

// Usage : If DHCP success, this function get the allocated network information from DHCP. <- tmp
